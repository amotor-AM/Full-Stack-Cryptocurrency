/* By default our SHA-256 algorythm produces hexadeciamal characters and bases the 
network difficulty off of that value. In the case of Bitcoin and other POW Blockchains 
Binary values are used instead of hexadecimal. This allows them to be more precise but 
also introduces a fair bit of complexity into the network. This complexity requires 
miners to have to work harder to generate valid hashes and therefore increases network 
overhead. This will ultimately lead to a lower network difficulty relative to total 
hashing power. In this file I am experamenting to see if the tradeoff of increased 
speed and possible security benefits outweigh the cost of a higher time to mine, 
greater workload, and lower network difficulty. */
